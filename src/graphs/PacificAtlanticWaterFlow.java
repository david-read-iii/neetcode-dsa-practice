 ...
 * where each element is a list [r, c] representing the row and column of the cell. You may return the answer in any
 * order.
 *
 * Example 1:
 *
 ...
 * Constraints:
 *
 * 1. 1 <= heights.length, heights[r].length <= 100
 * 2. 0 <= heights[r][c] <= 1000
 *
...
class PacificAtlanticWaterFlowTester {
    ...
    public static void printExample(int[][] heights, String exampleId) {
        ...
        System.out.println("pacificAtlantic" + exampleId + "=" + pacificAtlanticWaterFlow.pacificAtlantic(heights));
    }
